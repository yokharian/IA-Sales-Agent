...
class TestDocumentSearchTool:
    ...
    def test_document_search_comprehensive_scenarios(self):
        ...
        for test_case in test_cases:
            ...
            try:
                ...
                assert isinstance(e, (ValueError, TypeError, KeyError, AttributeError, AuthenticationError))
    ...
    def test_document_search_performance_scenarios(self):
        ...
        search_scenarios = [
            {
                "name": "Simple query",
                "inputs": {"query": "car information", "k": 3}
            },
            {
                "name": "Complex technical query",
                "inputs": {"query": "engine specifications and performance metrics", "k": 5}
            },
            {
                "name": "Query with threshold",
                "inputs": {"query": "vehicle maintenance", "k": 4, "score_threshold": 0.8}
            },
            {
                "name": "Large result set",
                "inputs": {"query": "automotive", "k": 10}
            }
        ]
    ...
    def test_document_search_edge_cases(self):
        ...
        edge_cases = [
            ...
            },
            {
                ...
                "inputs": {"query": "a" * 1000, "k": 3}
            },
            {
                "name": "Zero results requested",
                "inputs": {"query": "test", "k": 0}
            },
            {
